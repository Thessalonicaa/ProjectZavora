// filepath: e:\ProjectFainal\frontend\pages\seller\EditCar\[id].vue
<template>
  <div class="min-h-screen bg-gray-950 text-white p-6 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto relative z-10">
      ...
      <div class="mb-8">
        <button
          @click="goBack"
          class="inline-flex items-center gap-2 text-red-500 hover:text-red-400 font-semibold transition-colors"
        >
          <i class="fas fa-arrow-left"></i>
          {{ currentLanguage === 'th' ? 'ย้อนกลับ' : 'Back' }}
        </button>
      </div>
